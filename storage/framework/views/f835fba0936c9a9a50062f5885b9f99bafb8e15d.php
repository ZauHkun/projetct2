...
<head>
    ...
    <!-- font awesome font -->
    <link rel="stylesheet" href="<?php echo asset('/css/fontawesome/css/all.min.css'); ?>">    
...
<body>
    ...
    <script src="<?php echo asset('js/sale.js'); ?>"></script>
    <!-- data table -->
    <script src="<?php echo asset('/js/DataTables-1.10.20 JS/jquery.dataTables.min.js'); ?>"></script>
    <script>
